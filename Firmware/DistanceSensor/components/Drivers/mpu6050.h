...
public:
    ...
    /**
    * @brief Initialising I2C an setup registers
    */
    void Init();
     ...
     */
    bool GetSlave4TnterruptEnabled();
     ...
     */
    bool GetXNegativeMotionDetected();
     ...
     * @return Motion detection status.
     */
    bool GetXPositiveMotionDetected();
     ...
     * @return Motion detection status.
     */
    bool GetYNegativeMotionDetected();
     ...
     * @return Motion detection status.
     */
    bool GetYPositiveMotionDetected();
     ...
     * @return Motion detection status.
     */
    bool GetZNegativeMotionDetected();
     ...
     * @return Motion detection status.
     */
    bool GetZPositiveMotionDetected();
     ...
     */
    void SwitchSpieEnabled(bool enabled);
    ...
    void SetOtpBankValid(int8_t enabled);
     ...
     */
    float GetAccelRes(uint8_t accel_scale);
     ...
     * @return Resolution of the acceleration.
     */
    float GetGyroRes(uint8_t gyro_scale);
     ...
     */
    void Calibrate(float *accel_bias_res, float *gyro_bias_res);
